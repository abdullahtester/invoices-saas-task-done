...
<li class="nav-item {{ Request::is('super-admin/subscription-plan*','super-admin/transactions*')  ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('subscription-plans.index') }}">
       <span class="menu-icon">
...
<li class="nav-item {{ Request::is('super-admin/enquiries*')  ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('super.admin.enquiry.index') }}">
       <span class="menu-icon">
...
<li class="nav-item {{ Request::is('super-admin/subscribers*')  ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('super.admin.subscribe.index') }}">
       <span class="menu-icon">
...
<li class="nav-item {{ Request::is('super-admin/section-one*','super-admin/section-two*','super-admin/section-three*','super-admin/admin-testimonial*','super-admin/faqs*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('super.admin.section.one') }}">
       <span class="menu-icon">
...
{{-- Settings --}}
<li class="nav-item {{ Request::is('super-admin/general-settings*','super-admin/currencies*','super-admin/footer-settings*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('super.admin.settings.edit') }}">
        <span class="menu-icon">
