          ...
          <div class="mb-3" io-image-input="true">
                ...
                <div class="d-block">
                    <div class="image-picker">
                        ...
                        {{$style}}"{{$background}} url({{ isset($sectionOne['img_url_one']) ? asset($sectionOne['img_url_one']) : asset('landing-page/images/hero-image.png') }}">
                        </div>
                        <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip" title="edit">
                            <label>
                                <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                                    <input type="file" id="img_url_one" name="img_url_one" class="image-upload d-none"  accept="image/*"/>
                            </label>
                        </span>
                    </div>
                </div>
