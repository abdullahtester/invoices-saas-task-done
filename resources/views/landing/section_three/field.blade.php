            ...
            <div class="mb-3" io-image-input="true">
                ...
                <div class="d-block">
                    <div class="image-picker">
                        ...
                        {{$style}}"{{$background}} url({{ isset($sectionThree['img_url']) ? asset($sectionThree['img_url']) : asset('web_front/images/main-banner/banner-one/woman-doctor.png')}}">
                        </div>
                       <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip" title="edit">
                            <label>
                                <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                                    <input type="file" id="img_url" name="img_url" class="image-upload d-none"  accept="image/*"/>
                            </label>
                        </span>
                    </div>
                </div>
