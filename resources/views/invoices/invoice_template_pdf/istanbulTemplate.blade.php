...
<table width="100%">
    <tr>
        ...
        <td width="250px" {{ $styleCss }}="padding-left: 20px">
            <div class="logo">
                <img width="100px" src="{{ getLogoUrl($invoice->tenant_id) }}" alt="" class="object-contain">
            </div>
    ...
    <tr>
        ...
        <td>
            <table class="invoice-footer">
                ...
                <tr>
                    <td class="text-nowrap font-weight-bold tu" {{ $styleCss }}="
                    border-bottom: 2px solid {{ $invoice_template_color }};">Total Paid:</td>
