                                        ...
                                        <table class="table table-striped box-shadow-none mt-4">
                                            ...
                                            @foreach($quote->quoteItems as $index => $quoteItem)
                                                <tr>
                                                    ...
                                                    <td class="py-4 text-end">{{  isset($quoteItem->price) ? getCurrencyAmount($quoteItem->price,true,$quote->tenant_id) : 'N/A' }}</td>
                                                    <td class="py-4 text-end">{{ isset($quoteItem->total) ? getCurrencyAmount($quoteItem->total,true,$quote->tenant_id) : 'N/A' }}</td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
