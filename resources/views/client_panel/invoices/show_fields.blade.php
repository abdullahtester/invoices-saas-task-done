                                        ...
                                        <table class="table table-striped box-shadow-none mt-4">
                                            ...
                                            @foreach($invoice->invoiceItems as $index => $invoiceItem)
                                                <tr>
                                                    ...
                                                    <td class="py-4">{{ isset($invoiceItem->price) ? getInvoiceCurrencyAmount($invoiceItem->price,$invoice->currency_id,true) : 'N/A' }}</td>
                                                    <td class="py-4">
                                                    ...
                                                    <td class="py-4">{{ isset($invoiceItem->total) ? getInvoiceCurrencyAmount($invoiceItem->total,$invoice->currency_id,true): 'N/A' }}</td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
                                ...
                                <div class="bg-gray-100 rounded-15 p-md-7 p-5 h-100 mt-xxl-0 mt-5 col-xxl-9 ms-xxl-auto w-100">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-12 col-lg-4 col-sm-6 d-flex flex-column mb-xxl-7">
                                            ...
                                            <span class="fs-4 text-gray-900">{{ getInvoiceCurrencyAmount($paid,$invoice->currency_id,true) }}</span>
                                        </div>
                                        <div class="col-xxl-12 col-lg-4 col-sm-6 d-flex flex-column mb-xxl-7">
                                            <label for="name"
                                                   class="pb-2 fs-4 text-gray-600">{{ __('messages.invoice.remaining_amount') }}</label>
                                            <span class="fs-4 text-gray-900">{{ getInvoiceCurrencyAmount($dueAmount,$invoice->currency_id,true) }}
                                                </span>
                                        </div>
                                    </div>
                                </div>
