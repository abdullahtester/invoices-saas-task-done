...
<table class="w-100">
                ...
                @if(isset($quote) && !empty($quote))
                    @foreach($quote->quoteItems as $key => $quoteItems)
                        <tr>
                            ...
                            border-bottom: 1px solid {{ $quote_template_color }}">{{ $quoteItems->quantity }}</td>
                            <td class="number-align" {{ $styleCss }}="
                            border-bottom: 1px solid {{ $quote_template_color }}"><b class="euroCurrency">{{isset($quoteItems->price) ? getCurrencyAmount($quoteItems->price,true): 'N/A' }}</b></td>
                                    <td class="number-align" {{ $styleCss }}="
                                    border-bottom: 1px solid {{ $quote_template_color }}"><b class="euroCurrency">{{isset($quoteItems->total) ? getCurrencyAmount($quoteItems->total,true): 'N/A'}}</b></td>
                        </tr>
                    @endforeach
                @endif
                </tbody>
    ...
    <tr>
        <td colspan="2" class="vertical-align-bottom">
            <br><strong {{ $styleCss }}="color: {{ $quote_template_color }};">Regards</strong>
