        ...
        <td>
            <table class="invoice-footer">
                ...
                <tr>
                    ...
                    <td class="text-nowrap" {{ $styleCss }}="border-bottom: 1px solid {{ $invoice_template_color }}">
                    {!!   (numberFormat(array_sum($totalTax)) != 0 ) ? '<b class="euroCurrency">'.getInvoiceCurrencyAmount(array_sum($totalTax),$invoice->currency_id,true).'</b>' :'N/A' !!}
                    </td>
                </tr>
                <tr>
                    <td class="font-weight-bold tu"
                ...
                <tr>
                    <td class="font-weight-bold tu text-nowrap" {{ $styleCss }}="
                    border-bottom: 1px solid {{ $invoice_template_color }};">Total Due:</td>
                ...
                <tr>
                    <td class="font-weight-bold tu text-nowrap" {{ $styleCss }}="
                    border-bottom: 1px solid {{ $invoice_template_color }};">Total Paid:</td>
                    <td class="text-nowrap" {{ $styleCss }}="
                    color: green; border-bottom: 1 px solid {{ $invoice_template_color }}">
