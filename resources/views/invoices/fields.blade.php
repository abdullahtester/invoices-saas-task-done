            ...
            <div class="mb-5 col-lg-6 col-sm-12">
                ...
                <select id="invoiceCurrencyType" class="form-select" name="currency_id">
                    ...
                    @foreach($currencies as $key => $currency)
                        <option value="{{ $currency['id'] }}">{{$currency['icon']}}&nbsp;&nbsp;&nbsp; {{$currency['name']}}
                        </option>
                    @endforeach
                </select>
            </div>
            ...
            <table class="table table-striped box-shadow-none mt-4" id="billTbl">
                ...
                <tr class="tax-tr">
                    ...
                    <td class="text-end item-total pt-8 text-nowrap">
                        @if(!getSettingValue('currency_after_amount')) <span class="invoice-selected-currency">{{ getCurrencySymbol() }}</span>@endif
                        0.00 @if(getSettingValue('currency_after_amount')) <span class="invoice-selected-currency">{{ getCurrencySymbol() }}</span>@endif
                    </td>
                    <td class="text-end">
                    ...
                    <table class="table table-borderless box-shadow-none mb-0 mt-5">
                        ...
                        <tr>
                            ...
                            <td class="text-gray-900 text-end pe-0">
                                ...
                                @if(getSettingValue('currency_after_amount'))
                                    <span class="invoice-selected-currency">{{ getCurrencySymbol() }}</span>@endif
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-gray-900 text-end pe-0">
                                @if(!getSettingValue('currency_after_amount'))
                                <span class="invoice-selected-currency">{{ getCurrencySymbol() }}</span>@endif <span id="discountAmount">
                                    0
                            </span>
                                @if(getSettingValue('currency_after_amount'))
                                <span class="invoice-selected-currency">{{ getCurrencySymbol() }}</span>@endif
                        ...
                        <tr>
                            ...
                            <td class="text-gray-900 text-end pe-0">
                                @if(!getSettingValue('currency_after_amount'))
                                <span class="invoice-selected-currency">{{ getCurrencySymbol() }}</span>@endif <span id="totalTax">
                                    0
                            </span>
                                @if(getSettingValue('currency_after_amount'))
                                <span class="invoice-selected-currency">{{ getCurrencySymbol() }}</span>@endif
                        ...
                        <tr>
                            ...
                            <td class="text-gray-900 text-end pe-0">
                                @if(!getSettingValue('currency_after_amount'))
                                <span class="invoice-selected-currency">{{ getCurrencySymbol() }}</span>@endif <span id="finalAmount">
                                    0
                            </span>
                                @if(getSettingValue('currency_after_amount'))
                                <span class="invoice-selected-currency">{{ getCurrencySymbol() }}</span>@endif
