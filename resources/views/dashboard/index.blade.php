                               ...
                               class="mb-xl-8 text-decoration-none">
                                <div
                                    ...
                                    <div
                                        ...
                                        <i class="fa fa-money-check card-icon text-white"></i>
                                    </div>
                                    <div class="text-end text-white">
                                        <h2 class="fs-1-xxl fw-bolder text-white">
                                            {{getCurrencyAmount($invoice_amount)}}
                                        </h2>
                        ...
                        <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                            <a href="{{ route('invoices.index',['status'=>3]) }}"
                               class="mb-xl-8 text-decoration-none">
                                ...
                                <div
                                    class="bg-yellow-300 shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                    <div
                                        class="bg-cyan-300 widget-icon rounded-10 d-flex align-items-center justify-content-center">
                               ...
                               class="mb-xl-8 text-decoration-none">
                                <div
                                    ...
                                    <div
                                        ...
                                        <i class="fas fa-clipboard-check card-icon {{\Illuminate\Support\Facades\Auth::user()->dark_mode ? 'text-black' : 'text-white'}}"></i>
