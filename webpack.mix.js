...
], 'public/assets/css/front-third-party.css').version()

//front third party js
mix.scripts([
    'public/landing-theme/js/bootstrap.bundle.min.js',
    'public/landing-theme/js/swiper-bundle.min.js',
    'public/landing-theme/js/jquery.min.js',
    'public/landing-theme/js/glightbox.min.js',
    'public/landing-theme/js/overlay-scrollbars.min.js',
    'public/landing-theme/js/gsap.min.js',
    'public/landing-theme/js/main.js',
...
mix.sass('resources/assets/css/invoice-template-dark.scss',
    'public/assets/css/invoice-template-dark-mode.css').version();
