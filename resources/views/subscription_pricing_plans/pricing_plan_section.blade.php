            ...
            <div class="mb-7 text-center">
                ...
                <div class="justify-content-center mt-5">
                    <h4 class="text-center mb-6 mt-2">
                        ...
                        <span class="h6 text-gray-800 ml-2">/ {{ \App\Models\SubscriptionPlan::PLAN_TYPE[$subscriptionsPricingPlan->frequency] }}</span>
                        <br>
                    </h4>
            ...
            @else
                @if($currentActiveSubscription && !$currentActiveSubscription->isExpired() && ($subscriptionsPricingPlan->price == 0 || $subscriptionsPricingPlan->price != 0))
                    @if($subscriptionsPricingPlan->hasZeroPlan->count() == 0)
                        <a data-turbo="false" href="{{ $subscriptionsPricingPlan->price != 0 ? route('choose.payment.type', $subscriptionsPricingPlan->id) : 'javascript:void(0)' }}"
