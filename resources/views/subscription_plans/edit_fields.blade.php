<div class="row">
    ...
    <div class="col-md-4 mb-5 hide_for_trail">
        <div class="form-group">
            ...
            {{ Form::text('price', null , ['class' => 'form-control form-control-solid price-input price for_trail_required','placeholder' => __('messages.subscription_plans.price'), 'id'=>'price', 'required']) }}
        </div>
    </div>
    <div class="col-md-4 mb-5 hide_for_trail">
        <div class="form-group">
