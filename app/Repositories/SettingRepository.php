    ...
    public function updateSetting($input): bool
    {
        if(isset($input['invoice_settings'])){
            ...
            $settingInputArray = Arr::only($input, [
                'current_currency','decimal_separator','thousand_separator','currency_after_amount','invoice_no_prefix', 'invoice_no_suffix'
            ]);
        }else {
            ...
            $settingInputArray = Arr::only($input, [
                ...
                'time_zone', 'mail_notification', 'payment_auto_approved', 'country_code',
            ]);
        }
